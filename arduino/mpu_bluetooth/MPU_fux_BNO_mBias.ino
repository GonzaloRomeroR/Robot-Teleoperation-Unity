...
//    
    /*Serial.print("q0 = ");*/ tmserial.print(q[0]);
    tmserial.print(","); tmserial.print(q[1]); 
    tmserial.print(","); tmserial.print(q[2]); 
    tmserial.print(","); tmserial.print(q[3]); 
    }               
...
//    if(SerialDebug) {
    tmserial.print(",");
    tmserial.print(yaw, 2);
    tmserial.print(", ");
    tmserial.print(pitch, 2);
    tmserial.print(", ");
    tmserial.println(roll, 2);
//    
